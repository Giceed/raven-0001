const RAVEN_CACHE="raven-app-v66";
const RAVEN_SHELL=[
  ...
  "./js/map.js?v=66-god-zoom-fix1","./js/fog.js?v=41edge-tests1","./js/gps.js?v=48raven-readiness1","./js/raven-life.js?v=62-tamagotchi1",
  ...
  "./js/edge-tests.js?v=41edge-tests1","./js/game-tests.js?v=62-tamagotchi1","./js/pwa.js?v=66-god-zoom-fix1","./js/hub-flow.js?v=65-field-test1","./js/field-test.js?v=65-field-test1",
