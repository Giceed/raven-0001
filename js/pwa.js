...
window.addEventListener("DOMContentLoaded",()=>{updateRavenConnectionState();updateRavenInstallButton();if("serviceWorker" in navigator)navigator.serviceWorker.register("./service-worker.js?v=67-daily-activities1").catch(error=>console.warn("Raven App-Service konnte nicht gestartet werden.",error));});
